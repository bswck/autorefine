...
#
# Interact with skeleton-ci/skeleton-python (current version: https://github.com/skeleton-ci/skeleton-python/tree/0.0.2rc-214-gf428c12).
#
# This file was generated from skeleton-ci/skeleton-python@0.0.2rc-214-gf428c12.
# Instead of changing this particular file, you might want to alter the template:
# https://github.com/skeleton-ci/skeleton-python/tree/0.0.2rc-214-gf428c12/project/scripts/skeleton.%7B%7Bsref%7D%7D.bash.jinja
#
# Usage:
#
...
make_context() {
	...
	TIDELIFT_URL=$(cat <<- 'EOF'
		https://tidelift.com/subscription/pkg/pypi-autorefine?utm_source=pypi-autorefine
	EOF
	)
	export SKELETON
	SKELETON=$(cat <<- 'EOF'
	...
	SKELETON_REV=$(cat <<- 'EOF'
		https://github.com/skeleton-ci/skeleton-python/tree/0.0.2rc-214-gf428c12
	EOF
	)
	export SREV
	SREV=$(cat <<- 'EOF'
	...
	SKELETON_AND_REF=$(cat <<- 'EOF'
		skeleton-ci/skeleton-python@0.0.2rc-214-gf428c12
	EOF
	)
	export SNREF
	SNREF=$(cat <<- 'EOF'
	...
	GH_ENSURE_ENV=$(cat <<- 'EOF'
		jq -n '{"deployment_branch_policy": {"protected_branches": false,"custom_branch_policies": true}}' | gh api -H "Accept: application/vnd.github+json" -X PUT "/repos/bswck/autorefine/environments/$1" --silent --input -
	EOF
	)
    export LAST_REF="0.0.2rc-214-gf428c12"
